        ...
        <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-linear-to-br from-blue-50 via-indigo-50 to-purple-50 pt-12">
            ...
            <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-0">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    {/* محتوای متنی */}
                    <div className="text-center lg:text-right translate-y-10 transition-all duration-1000 ease-out">
                        ...
                        <h1 className="text-6xl xl:text-7xl font-bold text-gray-800 leading-20 xl:leading-24 mb-8">
                            ...
                            <span className="relative inline-block mt-1">
                                <span className="absolute -bottom-2 left-0 w-full h-3 bg-blue-500/20 -skew-x-12" />{/* underline */}
