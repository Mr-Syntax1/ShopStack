...
// -------------------------------------------------------------
// هر رکورد نشان‌دهنده یک فاکتور بلوپال و وضعیت پرداخت آن است.
// این مدل اجازه می‌دهد وضعیت پرداخت را بدون وابستگی به
// پاسخ لحظه‌ای بلوپال ذخیره و ردیابی کنیم (Idempotency وبهوک).
// =============================================================
