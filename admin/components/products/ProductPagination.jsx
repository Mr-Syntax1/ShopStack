        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-4 py-4 border-t border-gray-200">
            ...
            <div className="flex items-center gap-1">
                ...
                <button
                    ...
                    className="p-2 rounded-lg border border-gray-300 text-sm disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 transition-colors cursor-pointer"
                    title="اولین صفحه"
                >
                    <FirstPageIcon />
                </button>
