    ...
    return (
        <div className="p-4 md:p-6 lg:p-8 mt-6 lg:mt-0">
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <button
                    onClick={fetchOrders}
                    className="inline-flex items-center justify-center gap-2 self-start rounded-xl bg-white px-3.5 py-2.5 text-[13px] font-semibold text-gray-700 shadow-sm ring-1 ring-gray-200/80 transition-colors hover:bg-gray-50"
                >
